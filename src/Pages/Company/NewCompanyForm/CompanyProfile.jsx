...
//   useEffect(() => {
//     const apiUrl = 'https://api.yourserver.com/company'; // Replace with your actual API endpoint
...
//         <h4 className="font-sans font-bold text-start text-gray-400">Address:</h4>
//         <p className="text-start font-sans text-md mt-2">{company.address}</p>
//       </div>

//       <div className="text-left py-2 text-xl">
//         <h4 className="font-sans font-bold text-start text-gray-400">Website:</h4>
//         <p className="text-start text-black-!important font-sans bg-red-600 mt-2">
//           <a href={company.website} target="_blank" rel="noopener noreferrer">{company.website}</a>
//         </p>
//       </div>

//       <div className="text-left py-2 text-black text-xl">
//         <h4 className="font-sans font-bold text-start text-gray-400">Industry:</h4>
//         <p className="text-start font-sans text-md mt-2">{company.industry}</p>
//       </div>

//       <div className="text-left py-2 text-black text-xl">
//         <h4 className="font-sans font-bold text-start text-gray-400">Description:</h4>
//         <p className="text-start font-sans text-md mt-2">{company.description}</p>
//       </div>

//       <div className="text-left py-2 text-black text-xl">
//         <h4 className="font-sans font-bold text-start text-gray-400">Number of Employees:</h4>
//         <p className="text-start font-sans text-md mt-2">{company.employees}</p>
//       </div>
//     </div>
//   );
// };
      ...
      <div style={{ justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <div style={{ display: 'block' }}>
          {company.profilePicture && (
            <img
              src={`http://localhost:7000/${company.profilePicture}`}
              alt="Company Profile"
