...
function Companies() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://smartjobseeker-fe218b533e4f.herokuapp.com/api/user/CompanyList');
  ...
  const viewCompanyProfile = async (userId) => {
    ...
    try {
      const response = await axios.get(`https://smartjobseeker-fe218b533e4f.herokuapp.com/api/user/singleUser/${userId}`);
